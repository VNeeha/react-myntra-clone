...
const Header = () => {
  return (
    <header className={`${styles.header}`}>
      <nav className={`navbar navbar-expand-lg navbar-light bg-light px-3 container-fluid fixed-top ${styles.headerContent}`}>
        ...
        <div className="collapse navbar-collapse" id="navbarContent">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <Link to="/bag" className="text-center text-decoration-none text-dark position-relative">
